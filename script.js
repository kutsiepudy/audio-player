...
const availableSongs = [
  ...
  {artist: "Good Kid", track: "Cicada", date: "2026", file: "04-cicada.mp3", desc: "This song was released the same day, I was getting ready to finally reconcile with my girlfriend at the time (now ex) I hyped myself up told myself I matter, the moment I go to school that day I get ignored by her I shrug it off y'know, and then I see her hanging out with someone else calling them their girlfriend, essentially I got cheated on."},
  {artist: "batta", track: "chase", date: "2015", file: "chase.mp3", desc: "I was listening to it during a time where I was just starting to get bored of following routine, yeah there was something to look forward for everyday but I had one best friend at the time, and this song, followed by a girl who liked me and made it obvious, whenever I played the song I would think about playing it with a band, I still do."},
  ...
  {artist: "Good Kid", track: "Rift", date: "2026", file: "01-rift.mp3", desc: "Hey guys, so this song is cool, I also want to play this is in a band y'know, I really want to be in a band but I doubt I'll ever be in one."},
  {artist: "Sunny Day Service", track: "心に雲を持つ少年", date: "2020", file: "心に雲を持つ少年.mp3", desc: "I uhm, this might get personal, but every time I listen to this song I think about going out there and exploring the world and seeing stuff I've never been able to see spaces I want to see, I think about running away and seeig the world and such all because I tell myself that I don't want to work a 9 to 5 everyday until death."},
